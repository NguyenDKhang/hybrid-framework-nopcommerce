...
public class Common_01_Register_Cookie extends BaseTest{
	...
	public void Register(String browserName) {
		...
		log.info("Pre-Condition -Step 10: Enter to mail textbox with value is '"+email+"'");
		loginPage.inputToEmailTextbox(email);
		
		log.info("Pre-Condition -Step 11: Enter to pass textbox with value is '"+passWord+"'");
		...
		for (Cookie cookie : loggedCookies) {
			System.out.println("Cookie register: "+ cookie);
		}
